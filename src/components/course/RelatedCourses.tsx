...
const RelatedCourses: React.FC<RelatedCoursesProps> = ({ currentCourseId }) => {
  // Dummy course data for demonstration, filtered to exclude the current course
  const allCourses = [
    {
      id: "math-12-s1",
      ...
      image: "/images/20250630150800-ugrw2nuezq.png", // Updated image
