...
interface LessonDetailPageV2CloneProps {
...
const LessonDetailPageV2Clone: React.FC<LessonDetailPageV2CloneProps> = ({ initialLessonId }) => {
  const params = useParams<{ lessonId: string }>();
  const lessonId = initialLessonId ?? params.lessonId;
  ...
  const tourSteps = [
    {
      ...
      description:
        "Đây là nơi bạn sẽ xem các bài giảng video. Bạn có thể điều khiển phát/tạm dừng, tua nhanh/chậm tại đây.",
      position: "bottom",
    },
    {
      ...
      title: "Thêm ghi chú",
      description:
        "Nhấn vào đây để thêm ghi chú tại thời điểm hiện tại của video. Ghi chú sẽ giúp bạn ôn tập hiệu quả hơn.",
      position: "bottom",
    },
    {
    ...
    },
    {
      ...
      title: "Làm bài tập",
      description:
        "Sau khi xem xong bài giảng, hãy nhấn vào đây để làm bài tập thực hành và củng cố kiến thức.",
      position: "bottom",
    },
    {
      ...
      description:
        "Đây là danh sách các chương và bài học trong khóa. Bạn có thể chọn bài học tiếp theo tại đây.",
      position: "left",
    },
    {
      ...
      description:
        "Sử dụng nút này để thu gọn hoặc mở rộng cột nội dung khóa học, giúp bạn tập trung vào video hơn.",
      position: "top",
    },
    {
      ...
      title: "Nút Hướng dẫn",
      description:
        "Bạn có thể nhấn vào nút này bất cứ lúc nào để xem lại hướng dẫn sử dụng các tính năng của trang.",
      position: "bottom",
    },
  ];
  ...
  const prevLessonId =
    currentLessonIndex > 0 ? allLessons[currentLessonIndex - 1].sessionId : undefined;
  const nextLessonId =
    currentLessonIndex < allLessons.length - 1 ? allLessons[currentLessonIndex + 1].sessionId : undefined;
  ...
  const handleAddNoteSave = (content: string) => {
    console.log("Note added from LessonDetailPageV2Clone:", content);
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-100">
      ...
      <div className="flex-grow flex lg:flex-row overflow-hidden">
        <div
          className={`flex flex-col bg-white overflow-y-auto h-full relative ${
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-4 mt-0 px-6 pb-6 pr-24">
            <div className="flex items-center gap-4">
              <Button
                id="tour-download-no-ans"
                variant="ghost"
                className="text-orange-500 hover:text-orange-600 hover:bg-orange-50 rounded-full px-4 py-2"
              >
      ...
      <NotesSidebar isOpen={isNotesSidebarOpen} onClose={() => setIsNotesSidebarOpen(false)} />
      <AskQuestionSidebar isOpen={isAskQuestionSidebarOpen} onClose={() => setIsAskQuestionSidebarOpen(false)} />
...
export default LessonDetailPageV2Clone;